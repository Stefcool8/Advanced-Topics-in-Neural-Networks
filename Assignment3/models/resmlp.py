...
# Modified ResMLP configuration for CIFAR-100
class CIFAR100ResMLP(ResMLP):
    def __init__(self):
        super().__init__(
            in_channels=3,
            image_size=32,        # CIFAR-100 image size
            patch_size=4,         # Smaller patch size for 32x32 images
            num_classes=100,      # CIFAR-100 has 100 classes
            dim=384,              # Adjusted model dimensions for CIFAR
            depth=12,
            mlp_dim=384 * 4
        )
